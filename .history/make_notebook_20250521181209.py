...
Generates a Jupyter notebook "DiSC_stability_notebook.ipynb" containing:
  - Title and introduction
  - Key formulas (rendered in LaTeX)
  - Function definitions for geometry, stability, classification, visualization
  - Example runs over multiple configurations
...
# Write notebook to file in current directory
